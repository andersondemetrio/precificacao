...
#     combistivel=models.DecimalField(max_digits=10, decimal_places=2)
#     estacionamento_pegadgio=models.DecimalField(max_digits=10, decimal_places=2)
...
#começo da Classe Rubricas, esboço