...
urlpatterns = [
    ...
    path('export_orcamento_pdf/<int:rubrica_id>/', export_orcamento_pdf, name='export_orcamento_pdf'),
    path('export_orcamento/<int:rubrica_id>/', export_orcamento, name='export_orcamento'),
